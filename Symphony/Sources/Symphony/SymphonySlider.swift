...
public struct SymphonySlider<Value, Track, Fill, Thumb>: View
...
struct TestSlider: View {
    ...
    var body: some View {
        SymphonySlider(value: $value,
                       in: 0...100,
                       step: 1,
                       minimumValueLabel: Text("Min"),
                       maximumValueLabel: Text("Max \(value)"),
...
struct SymphonySlider_Previews: PreviewProvider {
